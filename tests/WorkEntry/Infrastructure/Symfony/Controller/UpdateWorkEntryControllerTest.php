...
use App\WorkEntry\Infrastructure\Symfony\Controller\UpdateWorkEntryController;
use Faker\Factory;
use Faker\Generator;
...
final class UpdateWorkEntryControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->controller = new UpdateWorkEntryController($this->commandBus);
    }
    ...
    public function testItUpdatesWorkEntrySuccessfully(): void
    {
        ...
        $this->commandBus
            ...
            ->method('send')
            ->with($this->callback(
                fn (UpdateWorkEntryCommand $cmd) => $cmd->id === $entryId
                && $cmd->userId === $userId
    ...
    public function testItThrowsWhenStartOrEndDateMissing(): void
    {
        $this->expectException(InvalidRequestException::class);
